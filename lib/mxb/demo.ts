  ...
  switch (id) {
    ...
    case "whoops": {
      ...
      return restTelemetry({
        ...
        gear: 3,
        speedMs: speed,
        position: { x: 0, y: 0.1 + bump * 0.1, z: t * speed },
    ...
    case "landing": {
      ...
      return restTelemetry({
        ...
        gear: 3,
        speedMs: 17,
        position: { x: 0, y: lerp(0.7, 0.02, hit), z: t * 17 },
        velocity: { x: 0, y: lerp(-4, 0.2, hit), z: 17 },
    ...
    case "wheelie": {
      ...
      return restTelemetry({
        ...
        gear: 2,
        speedMs: speed,
        position: { x: 0, y: 0.08 + up * 0.12, z: t * speed },
        velocity: { x: 0, y: 0.3, z: speed },
